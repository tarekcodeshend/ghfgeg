...
const getters = {
    ...
    towersBetAmount: state => state.towersBetAmount,
}
...
const mutations = {
    ...
    towers_set_bet_amount(state, game) {
        state.towersBetAmount = game;
    }
}
...
const actions = {
    ...
    towersSetBetAmount({ commit }, value) {
        commit('towers_set_bet_amount', value);
    },
        ...
        getters.socketTowers.emit('sendCashout', data, (res) => {
            if(res.success === true) {
                ...
                if(getters.soundTowers === 1) {           
                    ...
                    getters.soundCash.currentTime = 0;
