<template>
    <div class="roll-card" v-bind:class="{
        ...
        <div class="card-inner">
            <img class="card-inner-icon" src="@/assets/img/icon-logo.png" />
...
.roll-card .card-inner {
    ...
    background: linear-gradient(141deg, rgba(255, 255, 255, 0.28) 0%, rgba(118, 124, 139, 0.00) 63.4%), #1C2029;
    z-index: 1;
}

.roll-card .card-inner .card-inner-icon {
    position: absolute;
    width: 70%;
    top: 35%;
    left: 50%;
...
.roll-card.card-high .card-inner {
    ...
    background: linear-gradient(141deg, rgba(253, 59, 49, 0.28) 0%, rgba(253, 59, 49, 0.00) 63.4%), #1C2029;
    color: #FD3B31;
}
...
.roll-card.card-mid .card-inner {
    ...
    border-bottom: 0.5px solid #FFC700;
    border-left: 1px solid #FFC700;
    background: linear-gradient(141deg, rgba(255, 199, 0, 0.28) 0%, rgba(255, 199, 0, 0.00) 63.4%), #1C2029;
    color: #FFC700;
}

.roll-card.card-low .card-inner {
    border-radius: 15px;
    border-top: 1px solid #9731FD;
    border-right: 0.5px solid #9731FD;
    border-bottom: 0.5px solid #9731FD;
    border-left: 1px solid #9731FD;
    background: linear-gradient(141deg, rgba(151, 49, 253, 0.28) 0%, rgba(151, 49, 253, 0.00) 63.4%), #1C2029;
    color: #9731FD;
}
...
.roll-card.card-high .card-inner .inner-multiplier {
    color: #FD3B31;
}

.roll-card.card-mid .card-inner .inner-multiplier {
    color: #FFC700;
}

.roll-card.card-low .card-inner .inner-multiplier {
    color: #9731FD;
}
