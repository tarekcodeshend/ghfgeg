<template>
    <div class="modal-credit">
        ...
        <div class="credit-info">
            Card payments are processed through a secure third-party processor. STARFlip does not store or process your card details.
        </div>
    </div>
</template>
...
<style scoped>
    ...
    .modal-credit .amount-buttons button.button-active:before {
        background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, #ffdd00 100%);
    }
