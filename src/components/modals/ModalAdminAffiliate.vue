<template>
    <div class="modal-admin-affiliate">
        ...
        <div class="modal-title">Admin Affiliate</div>
        <div class="modal-content">
            ...
            <div class="affiliate-username">
                ...
                <BoxLevel v-if="['admin', 'mod'].includes(modalsData.affiliate.rank) === false"
                    v-bind:level="adminGetLevel" v-bind:color="adminGetLevelColor" />
            ...
            <div class="affiliate-settings">
                <div class="settings-element element-toggle">
                    ...
                    <button v-on:click="adminBlockToggle"
                        v-bind:class="{ 'button-active': modalsData.affiliate.limits.blockAffiliate === true }"
                ...
                <div class="stats-element">
                    <div class="element-inner">
                        ...
                        <div class="inner-amount">
                            <img src="@/assets/img/coins.8ad8b473.png" alt="icon" />
                            <div class="amount-value">
                                <span>{{ modalFormatValue(modalsData.affiliate.affiliates.deposit).split('.')[0]
                                    }}</span>.{{ modalFormatValue(modalsData.affiliate.affiliates.deposit).split('.')[1]
                                }}
                            </div>
                        </div>
                    </div>
                ...
                <div class="stats-element element-profit">
                    <div class="element-inner">
                        ...
                        <div class="inner-amount">
                            <img src="@/assets/img/coins.8ad8b473.png" alt="icon" />
                            <div class="amount-value">
                                <span>{{ modalFormatValue(modalsData.affiliate.affiliates.earned).split('.')[0]
                                    }}</span>.{{ modalFormatValue(modalsData.affiliate.affiliates.earned).split('.')[1]
                                }}
                            </div>
                        </div>
                    </div>
...
.modal-admin-affiliate .settings-element.element-toggle button.button-active::before {
