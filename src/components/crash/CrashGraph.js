...
Graph.prototype.configPlotSettings = function(config, forceUpdate) {
	...
	this.XDA = 800;
	this.YDA = window.innerWidth > 950 ? 725 : 500;
};
...
Graph.prototype.drawGraph = function() {
    ...
    grad.addColorStop(0, '#0089ff');
    grad.addColorStop(1, '#F4A338');
	...
	const width = window.innerWidth > 950 ? 180 : 80;
	const height = window.innerWidth > 950 ? 180 : 80;
	const posX = window.innerWidth > 950 ? 90 : 40; 
	const posY = window.innerWidth > 950 ? 155 : 50;
	if(Engine.gameState === 'IN_PROGRESS') { ctx.drawImage(this.imageObj, 0 - posX, 0 - posY, width, height); }
	ctx.restore();
};
