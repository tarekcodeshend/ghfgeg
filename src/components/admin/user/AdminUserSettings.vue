    ...
    <div class="admin-user-settings">
        ...
        <div v-if="modalsData.user.limits.blockTip === true" class="settings-element element-sub element-number">
            ...
            <div class="element-input">
                ...
                <button v-on:click="adminValueButton('limits.limitTip', Math.floor(adminLimitTip * 1000))"
        ...
        <div class="settings-element element-toggle">
            ...
            <button v-on:click="adminValueButton('limits.blockSponsor', !modalsData.user.limits.blockSponsor)"
                v-bind:class="{
        ...
        <div class="settings-element element-toggle">
            ...
            <button v-on:click="adminValueButton('limits.blockLeaderboard', !modalsData.user.limits.blockLeaderboard)"
                v-bind:class="{
        ...
        <div class="settings-element element-number">
            ...
            <div class="element-input">
                ...
                <button v-on:click="adminValueButton('vault.amount', Math.floor(adminVault * 1000))"
                    v-bind:disabled="socketSendLoading !== null">
                    <div class="button-inner">UPDATE</div>
                </button>
            </div>
        ...
        <div class="settings-element element-number">
            ...
            <div class="element-input">
                ...
                <button v-on:click="adminValueButton('stats.deposit', Math.floor(adminDeposit * 1000))"
                    v-bind:disabled="socketSendLoading !== null">
                    <div class="button-inner">UPDATE</div>
                </button>
            </div>
        ...
        <div class="settings-element element-number">
            ...
            <div class="element-input">
                ...
                <button v-on:click="adminValueButton('stats.withdraw', Math.floor(adminWithdraw * 1000))"
                    v-bind:disabled="socketSendLoading !== null">
                    <div class="button-inner">UPDATE</div>
                </button>
            </div>
...
.admin-user-settings .settings-element.element-toggle button.button-active::before {
