<template>
    <div class="admin-user-profile">
        ...
        <div class="profile-username">
            ...
            <BoxLevel v-if="['admin', 'mod', 'partner'].includes(modalsData.user.rank) === false"
        ...
        <div class="profile-actions">
            <a v-if="modalsData.user.roblox !== undefined"
                v-bind:href="'https://www.roblox.com/users/' + modalsData.user.roblox.id + '/profile'" target="_blank"
                class="link-account">
        ...
        <div class="profile-stats">
            ...
            <div class="stats-element element-profit"
                v-bind:class="{ 'element-negative': (modalsData.user.stats.withdraw - modalsData.user.stats.deposit) < 0 }">
                <div class="element-inner">
                    TOTAL PROFIT
                    <div class="inner-amount">
                        <img src="@/assets/img/coins.8ad8b473.png" alt="icon" />
                        <div class="amount-value">
                            <span>{{ adminFormatValue(modalsData.user.stats.withdraw -
                                modalsData.user.stats.deposit).split('.')[0]}}</span>.{{ adminFormatValue(modalsData.user.stats.withdraw
                                    - modalsData.user.stats.deposit).split('.')[1]}}
                        </div>
                    </div>
                </div>
            </div>
