<template>
    <div class="blackjack-value" v-bind:class="{
        ...
        <div class="value-inner">
            <!-- <svg v-if="state === 'won'" width="16" height="16" viewBox="0 0 16 16" fill="none"
                ...
                <defs>
                    <linearGradient id="blackjack-icon-linear-1" x1="16" y1="0" x2="-2.79248" y2="4.60555"
            ...
            <svg v-else-if="state === 'lose'" width="16" height="17" viewBox="0 0 16 17" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
...
.blackjack-value.value-active .value-inner {
