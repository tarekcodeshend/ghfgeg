<template>
    <div class="login-credientials">
        ...
        <div class="content-buttons">
            <button class="button-reset" v-on:click="modalResetButton()"
                v-bind:disabled="authSendLoginLoading === true">RESET</button>
        </div>
    </div>
</template>
...
.modal-login .content-buttons .button-reset {
...
.modal-login .content-buttons .button-reset:hover {
    background: #e4be4c
}
