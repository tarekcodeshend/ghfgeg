    ...
    <div class="login-credientials">
        ...
        <div class="password-content">
            ...
            <div class="password-input">
                ...
                <button v-on:click="$parent.modalSetTab('forgot')">Forgot Password</button>
            </div>
        </div>
        ...
        <div class="content-buttons">
            <button class="button-register" v-on:click="$parent.modalSetTab('register')">REGISTER</button>
            <button class="button-login" v-on:click="loginActionButton()">LOG IN</button>
        </div>
    </div>
</template>
...
.modal-login .password-input button:hover {
    color: #fff
}
...
.modal-login .content-buttons .button-login {
    border-radius: 9.583px;
    background: #0089ff;
    border-bottom: 2px solid #c9a22e;
    padding: 10px 22px;
    color: #FFF;
    text-shadow: 0px 3.833px 3.833px rgba(0, 0, 0, 0.23);
    font-family: Poppins;
...
.modal-login .button-roblox:hover {
    color: #fff
}
...
.modal-login .button-roblox:hover svg {
    fill: #fff
}
