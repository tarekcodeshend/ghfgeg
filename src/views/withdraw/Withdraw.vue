<template>
    <div class="deposit">
        <div class="deposit-nav">
            <router-link to="/withdraw/crypto" @click.native="setCurrentTab('crypto')">
        ...
        <div v-bind:class="{ 'deposit-sidebar': true, 'sidebar-open': sidebarToggle === true }">
            ...
            <div class="crypto-sidebar-transactions">
                <div class="transactions-header"> RECENT TRANSACTIONS
                ...
                <CashierRobuxTransaction v-if="currentTab === 'robux'" :cashierType="'withdraw'" />
                <CashierCryptoTransaction v-else-if="currentTab === 'crypto'" :cashierType="'withdraw'" />
            </div>
        </div>
    </div>
</template>
