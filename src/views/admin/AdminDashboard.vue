            ...
            adminGetChartData() {
                let data = {
                    ...
                    datasets: [{
                            ...
                            data: [],
                            fill: true,
                            backgroundColor: 'rgba(0, 199, 77, 0.2)',
                            borderColor: '#00c74d',
                            pointRadius: 5,
...
<style scoped>
    ...
    .admin-dashboard .growth-content {
        ...
        margin-top: 25px;
        border-radius: 15px;
        background: radial-gradient(180% 125% at 50% 15%, rgba(3, 43, 79, 0) 0%, #241D2E 100%);
    ...
    .admin-dashboard .content-chart {
        ...
        height: 100%;
        position: relative;
        background: repeating-linear-gradient(#161b23 0 1px, transparent 1px 100%),
                    repeating-linear-gradient(90deg, #161b23 0 1px, transparent 1px 100%);
