        ...
        <div class="filter-list">
            ...
            <div class="list-content">
                <transition name="fade" mode="out-in">
                    <div v-if="adminFilterList.data === null || adminFilterList.loading === true"
                        class="content-loading" key="loading">
                        <LoadingAnimation />
                    </div>
                    <div v-else-if="adminFilterList.data.length > 0" class="content-list" key="data">

                        <AdminFilterElement v-for="filter in adminFilterList.data" v-bind:key="filter._id"
            ...
            <div class="list-pagination">
                <button v-on:click="adminSetPage(adminFilterList.page - 1)" class="button-prev"
                    v-bind:disabled="adminFilterList.page <= 1">
                ...
                <div class="pagination-info">
                    PAGE <span class="text-green-gradient">{{ adminFilterList.page }}</span> /
                    {{ Math.ceil(adminFilterList.count / 12) <= 0 ? '1' : Math.ceil(adminFilterList.count / 12) }} </div>
                        <button v-on:click="adminSetPage(adminFilterList.page + 1)" class="button-next"
                            v-bind:disabled="adminFilterList.page >= Math.ceil(adminFilterList.count / 12)">
                            <div class="button-inner">
