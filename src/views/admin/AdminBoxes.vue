        ...
        <div class="boxes-list">
            ...
            <div class="list-content">
                <transition name="fade" mode="out-in">
                    <div v-if="adminBoxList.data === null || adminBoxList.loading === true" class="content-loading"
                        key="loading">
                        <LoadingAnimation />
                    </div>
            ...
            <div class="list-pagination">
                <button v-on:click="adminSetPage(adminBoxList.page - 1)" class="button-prev"
                ...
                <div class="pagination-info">
                    PAGE <span class="text-green-gradient">{{ adminBoxList.page }}</span> / {{ Math.ceil(adminBoxList.count
                        / 12) <= 0 ? '1' : Math.ceil(adminBoxList.count / 12)}} </div>
                        <button v-on:click="adminSetPage(adminBoxList.page + 1)" class="button-next"
            ...
            <div class="boxes-filters">
                ...
                <div class="filters-create">
                    ...
                    <div class="create-info">Categories: featured, low risk, 50/50, high risk and partners. Separate
                        categories with comma.</div>
                    ...
                    <button v-on:click="adminCreateButton()" class="button-create">
                        <transition name="fade" mode="out-in">
                            <ButtonLoading v-if="socketSendLoading === 'AdminBoxCreate'" />
                            <div v-else class="inner-content">CREATE BOX</div>
                        </transition>
                    </button>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        adminCreateButton() {
            ...
            let test = items.reduce((total, element) => total + element.tickets, 0)
