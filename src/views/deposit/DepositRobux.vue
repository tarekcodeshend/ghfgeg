    ...
    <div class="deposit-robux">
        <div class="robux-title">
            <div class="title-value">
                <span>ROBUX</span>CURRENCY
            </div>
        </div>
        <div class="robux-sub-title">
            <img src="@/assets/img/robux.png" alt="robux" />
            <span>ROBUX</span>
        </div>
        <div class="robux-withdraw-amount-title">Deposit Amount</div>
        <div class="robux-amount">
            <input v-model="modalAmount" v-on:input="modalValidateInput()" type="text"
                placeholder="Fill in carefully the amount of robux you wish to withdraw" />
        ...
        <div class="robux-info">
            <div class="info-deposit">
                Enter the amount of Robux that you would like to deposit. Make sure the amount entered doesn't exceed
                your Robux balance of your Roblox Account.
            </div>
        </div>
    </div>
</template>
